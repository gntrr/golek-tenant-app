...
<div class="flex flex-col gap-4">
    <div class="gap-2 mb-6">
        ...
        <h2 class="text-2xl font-semibold">Detail Booth - {{ $event->name }}</h2>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            @if($venueMapUrl)
                <div class="card bg-base-100 shadow">
                    <div class="card-body">
                        <h2 class="card-title">Denah Booth</h2>
                        <img src="{{ $venueMapUrl }}" alt="Venue Map" class="w-full rounded max-h-[70vh] object-contain" />
                    </div>
                </div>
            @endif
        </div>
        <div>
            <div class="card bg-base-100 shadow">
                <div class="card-body">
                    <h1 class="card-title text-2xl">Cek Booth Pada Event {{ $event->name }}</h1>
